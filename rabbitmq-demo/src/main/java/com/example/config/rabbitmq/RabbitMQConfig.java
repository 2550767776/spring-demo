...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding bindingTestQueue(Queue testQueue, TopicExchange exchange) {
        return BindingBuilder.bind(testQueue).to(exchange).with(TEST_QUEUE_NAME);
    }
